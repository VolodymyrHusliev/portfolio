					...
					<div class="footer-con-foot">
						<div class="footer-con-side">
							<div class="footer-tx1-founder">
								<div class="footer-ico-developer" style="background: url('/public_html/img/icons/footer/dh.png') center center / cover no-repeat;">
								</div>
								<div class="footer-ico-developer" style="background: url('/public_html/img/icons/footer/hykem.png') center center / cover no-repeat;">
								</div>
								<a href="/about">
						...
						<div class="footer-con-side">
							<div class="footer-tx1-webmaster">
								<div class="footer-ico-developer" style="background: url('/public_html/img/users/daginatsuko.png') center / cover no-repeat;">
								</div>
